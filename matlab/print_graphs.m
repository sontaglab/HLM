...
function [QS_nb] = print_graphs(nb_inputs,index,permutation,subplot_nb,offending)
    warning off
    load('summary.mat')
    load('maxgates.mat')
    if nb_inputs == 2
    ...
    subplot(2,3,subplot_nb)
    axis off
    QS_nb = build_tree(graphs,index,nb_inputs,maxgates,permutation,offending);
end